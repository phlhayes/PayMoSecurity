...
public class Graph<T> {
    ...
    /**
     * Check if Vertex exists in a Graph
     * 
     * @param v The vertex object. 
     * @return boolean
     */
    ...
    /**
     * Check if Edge exists in a Graph
     * 
     * @param v The vertex object. 
     * @param u The vertex object.
     * @return boolean
     */
    public boolean edgeExists(T[] vertices) {
        T v = vertices[0];
        T u = vertices[1];
        return this.adjacencyList.get(v).contains(u) && this.adjacencyList.get(u).contains(v);
    }
     ...
     */
    public void addEdge(T[] vertices) {
        T v = vertices[0];
        T u = vertices[1];
    ...
    /**
     * Calculate minimum distance between two vertices.
     * 
     * @return Integer number of edges
     */
    public Integer getDistance(T[] vertices) {
        T v = vertices[0];
        T u = vertices[1];
        BreadthFirst search = new BreadthFirst(this, v, u);
        return search;
